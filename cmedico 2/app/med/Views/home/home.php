...
<body>
    ...
    <thead>
    <a href="cadastrarmedico/cadmedico"  class="btn btn-xs btn-dark">Cadastrar Médico Med</a>
        <tr>
            <th>ID</th>
            <th>Nome</th>
            <th>CRM</th>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown d-block d-md-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        <?php
                                        if ($this->Dados['botao']['vis_carousel']) {
                                            echo "<a class='dropdown-item' href='" . URL . "ver-carousel/ver-carousel/$id'>Visualizar</a>";
                                        }
                                        if ($this->Dados['botao']['edit_carousel']) {
                                            echo "<a class='dropdown-item' href='" . URL . "editar-carousel/edit-carousel/$id'>Editar</a>";
                                        }
                                        if ($this->Dados['botao']['del_carousel']) {
                                            echo "<a class='dropdown-item' href='" . URL . "apagar-carousel/apagar-carousel/$id' data-confirm='Tem certeza de que deseja excluir o item selecionado?'>Apagar</a>";
                                        }
                                        ?>
