...
class StsCadastrarMedico
{
    ...
    public function verMedico($DadosId)
    {
        $this->DadosId = (int) $DadosId;
        $verCarousel = new \App\sts\Models\helper\AdmsRead();
    ...
    public function cadMedico(array $Dados)
    {
        $this->Dados = $Dados;
    ...
    {
        $uploadImg = new \App\sts\Models\helper\AdmsUploadImgRed();
    ...
    {
        $listar = new \App\sts\Models\helper\AdmsRead();
