...
/**
 * Description of MedCadastrarMedico
 *
 * @copyright (c) year, Call - MED
 */
class MedCadastrarMedico
{
    ...
    public function verUsuario($DadosId)
    {
        ...
        $verPerfil = new \App\med\Models\helper\MedRead();
        $verPerfil->fullRead("SELECT * FROM med_medicos WHERE id =:id LIMIT :limit", "id=" . $this->DadosId . "&limit=1");
    ...
    private function inserirUsuario()
    {
        ...
        $cadUsuario = new \App\med\Models\helper\MedCreate;
    ...
    {
        $listar = new \App\med\Models\helper\MedRead();
