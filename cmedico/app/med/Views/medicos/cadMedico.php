    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Cadastrar Medico</h2>
            </div>
            <?php
            if ($this->Dados['botao']['list_usuario']) {
                ?>
                <div class="p-2">
                <a href="<?php echo URL . 'medicos/listar'; ?>" class="btn btn-outline-info btn-sm">Listar</a>
            </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label><span class="text-danger">*</span> CRM</label>
                    <input name="crm" type="text" class="form-control" placeholder="CRM" value="<?php
                    if (isset($valorForm['crm'])) {
                        echo $valorForm['crm'];
                    }
                    ?>">
                </div>
