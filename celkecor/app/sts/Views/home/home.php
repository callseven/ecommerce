        ...
        <div class="jumbotron servicos">
                <div class="container">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card text-center anim_bottom">
                            <div class="icon-row tamanh-icone">
                                <span class="step size-96 text-danger">
                                    <i><ion-icon name="film-outline"></ion-icon></i>
                                </span>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card text-center anim_rigth">
                            <div class="icon-row tamanh-icone ">
                                <span class="step size-96 text-danger">
                                <i><ion-icon name="videocam-outline"></ion-icon></i>
                                </span>
                            </div>
                            <div class="card-body">
            ...
            <div class="jumbotron video">
                <div class="container">
                    ...
                    <p class="lead text-center anim_rigth"><?php echo $descricao; ?></p>
